# nvim-treesitter-queries-svelte

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-svelte/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-svelte/actions/workflows/validate.yml)

Neovim tree-sitter queries for **svelte**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-svelte",
...
- [ ] Changes are scoped to `svelte` — do not include files for other languages
